export const translations = {
  English: {
    ...
    deepCalm: "Deep calm",
    energizingBreathing: "Energizing Breathing",
    duration: "Duration",
    speed: "Speed",
    sound: "Sound",
    vibration: "Vibration",
  ...
  Ukrainian: {
    ...
    breathingExercises: "Дихальні вправи",
    boxBreathing: "Дихання по квадрату",
    fourSevenEight: "4-7-8 Релакс",
    deepCalm: "Глибокий спокій",
    energizingBreathing: "Енергійне дихання",
    duration: "Тривалість",
    speed: "Швидкість",
    sound: "Звук",
    vibration: "Вібрація",
